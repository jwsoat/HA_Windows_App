...
namespace HASS.Agent.Core.Models.Config
{
    /// <summary>
    /// Application settings — JSON contract is identical to the original appsettings.json
    /// so existing user config files load without changes.
    /// </summary>
    public class AppSettings
    {
        ...
        /// <summary>
        /// Kept for migration only — actual password stored in Windows Credential Manager.
        /// On first launch this is migrated to MqttCredentialVault and cleared here.
        /// </summary>
